...
import { Box, CardActions, CardContent, Chip, TextField, Button, Typography } from "@mui/material";
		...
		<StageCard currStage={app.stage} triggerStage={4} title="Swap" error={isError} sx={{width: '300px', marginBottom: '1rem'}}>
			<CardContent>
				<Box display="flex" flexDirection="column" gap={2}>
					...
					<Chip label={isFetching ? 'Swapping...' : typeof data !== 'undefined' ? `Recieved ${data} ${swap ? 'B' : 'A'} Tokens` : 'No Tokens Swapped'} />
				</Box>
			</CardContent>
			<CardActions>
